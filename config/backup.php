...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'include' => [
                    base_path(),
                    storage_path('app'),  // Inclure le storage pour les logos et fichiers uploadés
                ],
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@clinique.local'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'noreply@clinique.local'),
                'name' => env('MAIL_FROM_NAME', 'MyClinic Backup'),
            ],
        ],
