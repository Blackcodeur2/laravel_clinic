            ...
            <form method="POST" action="{{ route('patients.update', $patient) }}" class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="adresse" rows="3"
                              class="w-full px-4 py-2.5 bg-slate-800 border border-slate-700 rounded-xl text-white text-sm focus:outline-none focus:border-cyan-500 transition-colors resize-none">{{ old('adresse', $patient->adresse) }}</textarea>
                </div>
