<x-app-layout>
    ...
    <div class="max-w-2xl">
        <div class="rounded-2xl bg-gray-50 border border-gray-200 p-6" x-data="{
            ...
            <form method="POST" action="{{ route('services.store') }}" class="space-y-5" @submit="if (!validate()) $event.preventDefault()">
                @csrf
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="code" x-model="form.code" required
                               ...
                               :class="'w-full px-4 py-2.5 bg-white border rounded-xl text-gray-900 text-sm font-mono placeholder-slate-500 focus:outline-none transition-colors ' + (errors.code ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-cyan-500')"/>
