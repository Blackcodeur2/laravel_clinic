...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased bg-gray-200">
        ...
        <header class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-900">
                    ...
                    <div class="flex items-center gap-3">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-900 bg-clinic-600 rounded-lg hover:bg-clinic-700 transition-colors shadow-sm">
                                    <i class="bi bi-grid-1x2-fill"></i>
                                    Tableau de bord
                                </a>
                            @else
                                <a href="{{ route('login') }}" class="hidden sm:inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-900 hover:text-clinic-600 transition-colors">
                                    <i class="bi bi-box-arrow-in-right"></i>
                                    Connexion
                                </a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-900 bg-clinic-600 rounded-lg hover:bg-clinic-700 transition-colors shadow-sm">
        ...
        <section class="relative overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
                <div class="text-center max-w-3xl mx-auto">
                    ...
                    <p class="mt-6 text-lg sm:text-xl text-gray-900 leading-relaxed max-w-2xl mx-auto">
                    ...
                    <div class="mt-10 flex flex-wrap justify-center gap-4">
                        @if (Route::has('register'))
                            <a href="{{ Route::has('register') ? route('register') : '#' }}" class="inline-flex items-center gap-2 px-6 py-3 text-base font-semibold text-gray-900 bg-clinic-600 rounded-xl hover:bg-clinic-700 transition-all shadow-lg shadow-clinic-600/25 hover:shadow-clinic-600/40">
        ...
        {{-- Stats --}}
        <section class="bg-clinic-700 text-gray-900">
        ...
        <section id="fonctionnalites" class="py-20 lg:py-28">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-clinic-200 hover:shadow-lg hover:shadow-clinic-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Gestion des patients</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Dossiers patients centralisés, historique des consultations et suivi médical simplifié.</p>
                    </div>
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-200 hover:shadow-lg hover:shadow-blue-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Facturation</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Créez et envoyez des factures en quelques clics. Modèles personnalisables à votre image.</p>
                    </div>
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Paiements & encaissements</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Suivez les règlements, relances automatiques et état des créances en temps réel.</p>
                    </div>
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Rendez-vous</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Planifiez les consultations et évitez les conflits d'horaires au sein de votre équipe.</p>
                    </div>
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-amber-200 hover:shadow-lg hover:shadow-amber-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Rapports & statistiques</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Tableaux de bord clairs pour analyser votre activité et prendre de meilleures décisions.</p>
                    </div>
                    <div class="group p-6 rounded-2xl bg-white border border-gray-200 hover:border-rose-200 hover:shadow-lg hover:shadow-rose-100/50 transition-all duration-300">
                        ...
                        <h3 class="mt-4 text-lg font-semibold text-gray-900">Sécurité & conformité</h3>
                        <p class="mt-2 text-gray-900 text-sm leading-relaxed">Données chiffrées, accès par rôles et sauvegardes pour protéger vos informations.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        {{-- Benefits --}}
        <section id="avantages" class="py-20 bg-white border-y border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="p-6 rounded-2xl bg-clinic-50 border border-clinic-100">
                            ...
                            <p class="mt-4 text-2xl font-bold text-gray-900">-60%</p>
                            <p class="text-sm text-gray-900 mt-1">de temps administratif</p>
                        </div>
                        <div class="p-6 rounded-2xl bg-emerald-50 border border-emerald-100 mt-8">
                            ...
                            <p class="mt-4 text-2xl font-bold text-gray-900">+35%</p>
                            <p class="text-sm text-gray-900 mt-1">d'encaissements à temps</p>
                        </div>
                        <div class="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                            <i class="bi bi-file-earmark-medical text-3xl text-blue-600"></i>
                            <p class="mt-4 text-2xl font-bold text-gray-900">100%</p>
                            <p class="text-sm text-gray-900 mt-1">des dossiers centralisés</p>
                        </div>
                        <div class="p-6 rounded-2xl bg-violet-50 border border-violet-100 mt-8">
                            ...
                            <p class="text-sm text-gray-900 mt-1">satisfaction utilisateurs</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-clinic-600 to-clinic-800 px-8 py-16 sm:px-16 sm:py-20 text-center">
                    ...
                    <div class="relative">
                        ...
                        <div class="mt-8 flex flex-wrap justify-center gap-4">
                            ...
                            @endif
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-8 py-3.5 text-base font-semibold text-gray-900 border-2 border-white/30 rounded-xl hover:bg-white/10 transition-colors">
                                    <i class="bi bi-box-arrow-in-right"></i>
                                    Se connecter
                                </a>
                            @endif
